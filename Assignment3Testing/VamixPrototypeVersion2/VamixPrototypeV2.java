...
public class VamixPrototypeV2 {
	...
	private VamixPrototypeV2() {
		...
		_videoDisplayPanel.add(_fileLabel);
		_videoDisplayPanel.add(_embeddedMediaPlayer);
		_videoDisplayPanel.add(_videoProgressBar);
		...
		_mainPanel.add(_videoDisplayPanel);
		_mainPanel.add(_videoControlsPanel);
	...
	private ActionListener setOverlayTextButton() {
		return new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				JFrame textOverlayWindow = new JFrame("Overlay Text");
				textOverlayWindow.setContentPane(new TextOverlayPanel());

				textOverlayWindow.setLocation(150, 150);
				textOverlayWindow.setSize(400, 400);
				textOverlayWindow.setVisible(true);
			}
