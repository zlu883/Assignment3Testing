...
import Dialogs.TextOverlayWindow;
import Main.GuiManager;

public class TextOverlay implements AvConvObject {
	...
	public String createBashCommand() {
		...
		Dialogs.ExportWindow.getInstance().addToTempFiles(pathToTempTextFile);
	...
	public BashCommand createBashCommand(String fileName) {
		// TODO Auto-generated method stub
		return CommandManager.drawtextCommand(GuiManager.getInstance().getVideoFilePath(), fileName, TextOverlayWindow.getInstance().getTOpanel().getTextOverlayComponents());
	}
